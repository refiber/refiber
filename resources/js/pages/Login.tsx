    ...
    <div>
      ...
      <div className="mt-6 flex gap-3">
        ...
        >
          ...
          <button
            className="rounded-md w-full bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            type="submit"
    ...
    <div>
      <div className="relative rounded-sm">
        <input
          {...props}
          className={cn(
            "block w-full rounded-md border-0 py-1.5  shadow-xs ring-1 ring-inset focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6",
            !isError
